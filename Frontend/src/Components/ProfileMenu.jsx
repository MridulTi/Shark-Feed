    ...
    return (
      <Menu>
        <MenuHandler>
            ...
            variant="circular"
            alt="tania andrew"
            className="cursor-pointer hover:outline-2 outline outline-gray-5 outline-0"
            src={userInfo.avatar}
          />
          <p className="text-xs tracking-wider">Me</p>
            </div>
          
        </MenuHandler>
        <MenuList>
          <Link to="/Profile" className="outline-0"><MenuItem className="flex items-center gap-2">
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
